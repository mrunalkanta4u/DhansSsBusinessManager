namespace U2UConsult.WinRT.Controls
{
    using System;
    ...
    public sealed class ImageCropper : Control, INotifyPropertyChanged
    {
        ...
        public async Task LoadImage(StorageFile imageFile)
        {
            ...
            else
            {
                ...
                //if (this.sourceImagePixelHeight > 600 ||
                //    this.sourceImagePixelWidth > 300)
                //{
                //    sourceImageScale = Math.Min(300/ this.sourceImagePixelWidth,
                //         600 / this.sourceImagePixelHeight);
                //}
                //else
                //{
                //}
                ...
                this.sourceImage.Source = 
                    ...
                    await CropBitmap.GetCroppedBitmapAsync(
