...
{
    public sealed class AutomaticBackupTask : IBackgroundTask
    {
        ...
        public async void Run(IBackgroundTaskInstance taskInstance)
        {
            ...
            StorageFolder backupFolder = await roamingFolder.CreateFolderAsync("DhansSsBackup\\", CreationCollisionOption.ReplaceExisting);
            ...
            if (File.Exists(Path.Combine( roamingFolder.Path.ToString(), "MyNameList.json")))
            {
                ...
                await fileToCopy.CopyAsync(backupFolder, "MyNameList.json", NameCollisionOption.ReplaceExisting);
            }
            if (File.Exists(Path.Combine(roamingFolder.Path.ToString(), "MyDreamList.json")))
            {
                ...
                await fileToCopy.CopyAsync(backupFolder, "MyDreamList.json", NameCollisionOption.ReplaceExisting);
            }
            if (File.Exists(Path.Combine(roamingFolder.Path.ToString(), "MyTeamList.json")))
            {
                ...
                await fileToCopy.CopyAsync(backupFolder, "MyTeamList.json", NameCollisionOption.ReplaceExisting);
            }
            if (File.Exists(Path.Combine(roamingFolder.Path.ToString(), "MyCallLogs.json")))
            {
                ...
                await fileToCopy.CopyAsync(backupFolder, "MyCallLogs.json", NameCollisionOption.ReplaceExisting);
            }

            //Archive(backupFolder, backupFile);
            // backup to cloud or local storage
            
            await backupFile.DeleteAsync(StorageDeleteOption.Default);
